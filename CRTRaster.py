...
import CRTRaster_epy_block_0 as epy_block_0  # embedded python block
import sip
import threading



class CRTRaster(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "CRTlikeRaster", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("CRTlikeRaster")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "CRTRaster")
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, 'C:\\Users\\maxfd\\OneDrive\\Documents\\IST_815\\Project_Vandal\\CRT_Raster_Raw_IQ', False)
        self.blocks_file_sink_0.set_unbuffered(False)
        self.blocks_add_const_vxx_0 = blocks.add_const_ff(0.3)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 200e3, 1.0, 0, 0)
...
def main(top_block_cls=CRTRaster, options=None):
